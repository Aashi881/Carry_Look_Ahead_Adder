...
HD_PWD='D:/Vivado_Projects/CLA_16bit_Project/CLA_16bit_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cla_16bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cla_16bit.tcl -notrace
