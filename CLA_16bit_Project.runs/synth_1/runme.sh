...
HD_PWD='D:/Vivado_Projects/CLA_16bit_Project/CLA_16bit_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cla_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cla_16bit.tcl
